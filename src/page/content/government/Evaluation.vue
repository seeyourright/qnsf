  ...
  export default {
    ...
    methods: {
      getData (page) {
        ...
        this.$http.get(this.$url.Questionnaire_List, {page, limit: this.size, type: '民意测评', ...this.condition}).then(res => {
          if (res.code === 200) {
      ...
      detailHandler (row) {
        this.$router.push('/home/evaluationDetail?id=' + row.questionnaireId)
      },
      deleteAllHandler () {
      ...
      addHandler () {
        this.$router.push('/home/evaluationAdd')
      }
    }
  }
</script>
