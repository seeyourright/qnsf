<template>
  <div class="lawConsult">
    <div class="dlg">
      ...
      <lawHelp v-show="radio1 == 2"></lawHelp>
      <div class="lc_form" v-show="radio1 == 1">
...
export default {
  ...
  mounted() {
    ...
    let res = JSON.parse(sessionStorage.getItem("lawHelpHome"));
    console.log(res);
    this.mode = res.mode;
    if (res.id) {
      this.id = res.id;
