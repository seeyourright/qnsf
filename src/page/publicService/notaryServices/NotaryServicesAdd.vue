      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <el-form-item label="账号" prop="gzcAccount">
            <el-input v-model="form.gzcAccount"></el-input>
          </el-form-item>
          <el-form-item label="密码" prop="gzcPassword">
            <el-input v-model="form.gzcPassword"></el-input>
          </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      async add () {
        ...
        this.$http.post(this.$url.Add_Notarial_Office, params).then(res => {
          if (res.code === 200) {
