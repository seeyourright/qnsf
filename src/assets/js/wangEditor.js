    ...
    _createPanel: function _createPanel() {
        ...
        var panel = new Panel(this, {
            ...
            tabs: [
              {
                title: '上传视频',
                tpl: '<div class="w-e-up-img-container"><div id="' + upTriggerVideoId + '" class="w-e-up-btn"><i class="w-e-icon-upload2"></i></div><div style="display:none;"><input id="' + upFileVideoId + '" type="file" multiple="multiple" accept="video/*"/></div></div>',
                events: [{
                  // 触发选择图片
...
UploadImg.prototype = {
    ...
    uploadVideo: function uploadVideo(files){
      ...
      var editor = this.editor;
      var config = editor.config;
      var maxLength = config.uploadVideoMaxLength || 1;
...
export default this.wangEditor
